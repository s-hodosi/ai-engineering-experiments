...
Exclude jobs from known low-quality/repost-spam posting sources before they reach the LLM relevance filter, while keeping them auditable for observability.
