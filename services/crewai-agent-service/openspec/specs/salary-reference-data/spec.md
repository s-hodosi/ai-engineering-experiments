# Spec: Salary Reference Data

## Purpose

Defines how salary reference data is loaded, injected into the salary agent prompt, and how the agent produces structured, calibrated salary estimates in monthly gross HUF.
